...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "group flex flex-1 list-none justify-center gap-1 max-lg:flex-col lg:items-center lg:gap-6",
      className,
    )}
    {...props}
  />
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center text-xl font-satoshi font-normal justify-center rounded-md bg-white py-2  transition-colors  hover:text-neutral-900 max-lg:hover:text-neutral-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50  dark:bg-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[active]:bg-neutral-800/50 dark:data-[state=open]:bg-neutral-800/50 max-lg:bg-transparent",
);
